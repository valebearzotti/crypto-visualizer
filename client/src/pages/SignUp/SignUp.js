...
import { Container, Center, CircleOne, CircleTwo, Divider, Box, Title, Input, Subtitle, Button, Link } from '../Login/Login.styled'
            ...
            <Center>
                ...
                <Divider ref={box3}>
                    <Box>
                        ...
                        <Subtitle>Already have an account? <Link href="/login">Log in.</Link></Subtitle>
